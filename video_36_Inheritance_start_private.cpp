...
class programmer : private Employee //Here it will call dafault constructor of Employee
{
	public:
		int languagecode;
	...
	int getData()
	{
		cout<<"getData Function get called and Neede also because these varibales are inheried as Private so they can be acces by ."<<endl;
...
int main()
{
	...
	//cout<<"Value of id is "<<p1.id<<endl; //These will not work because inheritance type is private
